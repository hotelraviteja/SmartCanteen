...
import { Utensils, Clock, QrCode, ShieldCheck, Ticket, Users, TrendingDown, Star } from "lucide-react";
        ...
        <div className="relative z-10 w-full max-w-lg flex flex-col justify-between h-full">
          ...
          <div className="my-auto py-8 space-y-8">
            ...
            <div className="relative pt-4 text-left">
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-orange-200/70 dark:text-neutral-500">Token ID: #CB-3891</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-left">
                    <span className="text-[10px] text-orange-200/70 dark:text-neutral-500 block uppercase font-bold tracking-wider">Pass Verification</span>
              ...
              {/* Floating Queue Traffic load status (Framer motion float) */}
              <motion.div

...
export const ProtectedRoute = ({ children }) => {
  const { isAuthenticated, loading, isLocked, isSessionExpired } = useAuth();
    ...
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-white dark:bg-neutral-950">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="font-heading text-sm font-semibold tracking-wide text-neutral-500 dark:text-neutral-400">
